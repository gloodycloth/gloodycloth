...
<?php while ( have_posts() ) : the_post(); ?>
	...
	<div class="checkout-breadcrumb">
		<h1>
			<span class="title-cart"><?php _e('Keranjang Belanja', 'flatsome'); ?></span>   
			<span class="icon-angle-right divider"></span>    
			<span class="title-checkout"><?php _e('Detail Checkout', 'flatsome'); ?></span>  
			<span class="icon-angle-right divider"></span>  
			<span class="title-thankyou"><?php _e('Order Selesai', 'flatsome'); ?></span>
		</h1>
	...
	<div class="checkout-breadcrumb">
		<h1>
			...
			<span class="title-checkout"><?php _e('Detail Checkout', 'flatsome'); ?></span>  
			<span class="icon-angle-right divider"></span>  
			<span class="title-thankyou"><?php _e('Pesanan Berhasil', 'flatsome'); ?></span>
		</h1>
	</div>
	<?php } ?>
