...
<form id="order_review" method="post">
	...
	<table class="shop_table">
		<thead>
			<tr>
				<th class="product-name"><?php _e( 'Produk', 'woocommerce' ); ?></th>
			...
			<ul class="wc_payment_methods payment_methods methods">
				<?php
					if ( ! empty( $available_gateways ) ) {
						...
						echo '<li>' . apply_filters( 'woocommerce_no_available_payment_methods_message', __( 'Maaf , tampaknya tidak ada metode pembayaran yang tersedia, Silahkan hubungi kami jika Anda memerlukan bantuan', 'woocommerce' ) ) . '</li>';
					}
				?>
			</ul>
		<?php endif; ?>
