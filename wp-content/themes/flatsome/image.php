					...
					<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
						<header class="entry-header">
							...
							<div class="entry-meta">
								...
								?>
								<?php edit_post_link( __( 'Ubah', 'flatsome' ), '<span class="sep"> | </span> <span class="edit-link">', '</span>' ); ?>
							</div><!-- .entry-meta -->
						</header><!-- .entry-header -->
						...
						<footer class="entry-meta">
							...
							<?php elseif ( ! comments_open() && pings_open() ) : // Only trackbacks open ?>
								<?php printf( __( 'Komentar ditutup, tapi Anda dapat meninggalkan sebuah trackback: <a class="trackback-link" href="%s" title="Trackback URL untuk postingan Anda" rel="trackback">Trackback URL</a>.', 'flatsome' ), get_trackback_url() ); ?>
							<?php elseif ( comments_open() && ! pings_open() ) : // Only comments open ?>
								<?php _e( 'Trackbacks ditutup, tapi Anda bisa <a class="comment-link" href="#respond" title="Posting komentar">post a comment</a>.', 'flatsome' ); ?>
							<?php elseif ( ! comments_open() && ! pings_open() ) : // Comments and trackbacks closed ?>
								<?php _e( 'Both comments dan trackbacks baru saja ditutup.', 'flatsome' ); ?>
							<?php endif; ?>
							<?php edit_post_link( __( 'Ubah', 'flatsome' ), ' <span class="edit-link">', '</span>' ); ?>
						</footer><!-- .entry-meta -->
