...
function flatsome_add_to_cart_dropdown( $fragments ) {
	...
	<a href="<?php echo esc_url( $woocommerce->cart->get_cart_url() ); ?>" class="cart-link">
                    <strong class="cart-name hide-for-small"><?php _e('Keranjang', 'woocommerce'); ?></strong> 
					...
					<div class="cart-icon">
                        ...
                        <img class="custom-cart-icon" alt="<?php _e('Keranjang', 'woocommerce'); ?>" src="<?php echo $flatsome_opt['custom_cart_icon']?>"/> 
							...
							<div  class="nav-dropdown">
                                ...
                                <?php                                    
                                    if (sizeof($woocommerce->cart->cart_contents)>0) {
                                        ...
                                        echo '<p class="empty">'.__('Keranjang Anda Kosong.','woocommerce').'</p>';
                                    }                     
                                ?>                                                                        
